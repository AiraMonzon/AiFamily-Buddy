...
public class IncomeFragment extends Fragment implements IncomeAdapter.ItemClickListener{
    View view;
...
//               AggregateQuerySnapshot aggregateQuerySnapshot = task.getResult();
////               Toast.makeText(getActivity(), "Count: " + aggregateQuerySnapshot.getCount(), Toast.LENGTH_LONG).show();
//               incomeCollectionCount = aggregateQuerySnapshot.getCount();
//               if(incomeCollectionCount > 0){
...
//           }
//           else{
//               Toast.makeText(getActivity(), "Count Failed: "+ task.getException(), Toast.LENGTH_LONG).show();
//           }
//        });
